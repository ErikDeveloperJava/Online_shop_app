                            ...
                            <div class="tab-pane fade show active" id="register" role="tabpanel" aria-labelledby="register-tab">
                                <c:if test="${page == 1}">
                                    <div class="card shadow-sm">
                                        <div class="card-body">
                                            <form action="/admin/category/attr/1" method="post" >
                                                <div class="form-row">
                                                    <div class="form-group col-sm-6">
                                                        <label for="categories">Name</label>
                                                        <select id="categories" name="catId">
                                                    ...
                                                    <div class="form-group col-sm-6">
                                                        <label for="count">Attribute count</label>
                                ...
                                <c:if test="${page == 2}">
                                    <div class="card shadow-sm">
                                        <div class="card-body">
                                            <form action="/admin/category/attr/2" method="post" >
                                                <c:if test="${attrError != null}">
                                                    <span style="color: red">${attrError}</span>
                                                </c:if>
                                                <div class="form-row">
                                                    <div class="form-group col-sm-6">
                                                        <c:forEach begin="0" end="${count -1}" varStatus="status">
                                                            <label for="${status.index}">Name</label>
                                                            <input type="text" name="attr" class="form-control" id="${status.index}">
                                                        </c:forEach>
                                                    </div>
                                                    <div class="form-group col-12">
